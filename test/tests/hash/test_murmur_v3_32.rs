...
fn empty_data_same_seed() {
    ...
    let seed = 0xfd;
    let hash0 = murmur_v3_32(&data0, seed);
    let hash1 = murmur_v3_32(&data1, seed);
...
fn empty_data_different_seed() {
    ...
    let seed0 = 0xfd;
    let seed1 = 0xfe;
    let hash0 = murmur_v3_32(&data0, seed0);
    let hash1 = murmur_v3_32(&data1, seed1);
